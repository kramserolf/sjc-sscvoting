  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left image">
        <img src="../images/sjc.png" alt="sjc logo" style="height:auto; width:40px;">
      </div>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="vote_count.php"><span class="glyphicon glyphicon-book"></span> <span>Vote Counts</span></a></li>
